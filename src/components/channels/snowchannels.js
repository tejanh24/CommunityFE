...
class Snowchannels extends Component {
    constructor(props) {
        super(props);
    ...
    handleInputChange(event) {
        ...
        //alert("::::::::::   bot_id    ::::::::::::" + this.state.bot_id);
    ...
    onSubmitButtonClick() {
        ...
        if (this.state.mouriwebchannel == true) {
            const mouriwebchannel_obj =
            {
                ...
                "channel_display_name": "SERVICENOW BOT",
        ...
        const enabled_bot_services = JSON.parse(localStorage.getItem('snowbot_enabled_bot_services'));
        console.log("enabled_bot_services is" + enabled_bot_services);

        //botsdata
        const botname =  "snowbot";  // localStorage.getItem('botname');
        ...
        console.log("auth username in channal" + authusername);
        ...
        console.log("bot_id in snow channal :"+bot_id);
        ...
        const obj = {
            ...
            "application_config": [{
                ...
                "bot_display_name" : "ServiceNow Helpdesk Assistant",
                "bot_connector_id": "A12345678",
        ...
        console.log(":::::::::::::::::    REQUEST OBJECT        ::::::::::::::::::" + JSON.stringify(obj));
                ...
                <Row>
                        ...
                        <Card className="text-black bg-white cardstyle" >
                            ...
                            <CardBody className="pb-0">
                                <div class="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} value={this.state.skype}   checked={this.state.skype} class="custom-control-input" id="switch1" name="skype" />
                    ...
                    <Col xs="12" sm="6" lg="3">
                        <Card className="text-black bg-white cardstyle" >
                            <CardBody className="pb-0">
                                <div class="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} value={this.state.mouriwebchannel}  checked={this.state.mouriwebchannel}  class="custom-control-input" id="switch4" name="mouriwebchannel" />
