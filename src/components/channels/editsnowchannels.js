...
class EditSnowchannels extends Component {
    constructor(props) {
        super(props);
    ...
    onSubmitButtonClick() {
        ...
        const obj = {
            ...
            "application_config": [{
                ...
                "bot_name": botname,
                "bot_display_name": "SERVICENOW BOT",
                ...
                <Row>
                        ...
                        <Card className="text-black bg-white cardstyle" >
                            ...
                            <CardBody className="pb-0">
                                <div class="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} value={this.state.skype} class="custom-control-input" id="switch1" name="skype" />
                    ...
                    <Col xs="12" sm="6" lg="3">
                        <Card className="text-black bg-white cardstyle" >
                            <CardBody className="pb-0">
                                <div class="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} value={this.state.mouriwebchannel} class="custom-control-input" id="switch4" name="mouriwebchannel" />
...
export default EditSnowchannels;
