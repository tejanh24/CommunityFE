...
class HRchannels extends Component {
    constructor(props) {
        super(props);
    ...
    handleInputChange(event) {
       ...
       // console.log("in hr channal bot id:"+localStorage.getItem("bot_id"));
    ...
    onSubmitButtonClick() {
        ...
        if (this.state.mouriwebchannel == true) {
            const mouriwebchannel_obj =
            {
                ...
                "channel_display_name": "SUCCESSFACTORS BOT",
        ...
        if (this.state.msteams == true) {
            const msteams_obj =
            {
                ...
                "channel_display_name": "SUCCESSFACTORS BOT",
                "webhook_url": this.state.server_endpoint + "/api/hooks/msteams/" + this.state.bot_id,
                "channel_app_id": "",
                "channel_app_password": ""
            }
        ...
        if (this.state.whatsapp == true) {
            const whatsapp_obj =
            {
                ...
                "channel_display_name": "SUCCESSFACTORS BOT",
                "webhook_url": this.state.server_endpoint + "/api/hooks/whatsapp/" + this.state.bot_id,
                "channel_app_id": "",
                "channel_app_password": ""
            }
        ...
        console.log("bot_id in hr channal :"+bot_id);
        ...
        const obj = {
            ...
            "application_config": [{
                ...
                "bot_name" : "hr_bot",
                "bot_display_name" : "HR Assistant",
                // "client_id":client_id,
                // "client_secret":client_secret,
                //"bot_name": botname,
                // "bot_display_name": "SUCCESSFACTORS BOT",
                "bot_connector_id": "B12345678",
    ...
    componentDidMount() {
        ...
        //  alert("botchannels......." + JSON.stringify(botchannels));
       
        if (botchannels !== null) {
            botchannels.forEach(botservice => {
                //console.log(botservice);
                //alert(botservice.channel_name)
    ...
    render() {
        return (
            <div className="animated fadeIn">
                ...
                <Row>
                        ...
                        <Card className="text-black bg-white cardstyle" >
                            <CardBody className="pb-0">
                                ...
                                <div className="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} value={this.state.slack} checked={this.state.slack} className="custom-control-input" id="switch2" name="slack" />
                        ...
                        <Card className="text-black bg-white cardstyle" >
                            ...
                            <CardBody className="pb-0">
                                <div class="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} checked={this.state.skype} value={this.state.skype} className="custom-control-input" id="switch1" name="skype" />
                    ...
                    <Col xs="12" sm="6" lg="3">
                        <Card className="text-black bg-white cardstyle" >
                            <CardBody className="pb-0">
                                <div class="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} checked={this.state.whatsapp} value={this.state.whatsapp} class="custom-control-input" id="switch3" name="whatsapp" />
                    ...
                    <Col xs="12" sm="6" lg="3">
                        <Card className="text-black bg-white cardstyle" >
                            <CardBody className="pb-0">
                                <div class="custom-control custom-switch newpillclass">
                                    <input type="checkbox" onChange={this.handleInputChange} value={this.state.ciscoapark} checked={this.state.ciscospark} class="custom-control-input" id="switch6" name="ciscospark" />
                ...
                <Button color="primary" onClick={(e) => this.previousButtonClick()}>Previous</Button>
