...
class SNOWBotServices extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            getincidentsurl: "/api/now/table/incident?sysparm_query=assigned_to.first_name%3D{username_first_name}%5Eassigned_to.last_nameSTARTSWITH{username_last_name}%5EstateNOT%20IN3%2C6%2C7%2C8&sysparm_fields=number%2Cshort_description%2Cpriority%2Cbusiness_duration%2Csys_id&sysparm_limit=10",
            getchangesurl: "/api/now/table/change_request?sysparm_query=assigned_to.first_name%3D{username_first_name}%5Eassigned_to.last_nameSTARTSWITH{username_last_name}%5EstateNOT%20IN3%2C6%2C7%2C8&sysparm_fields=number%2Cshort_description%2Cpriority%2Cbusiness_duration%2Csys_id&sysparm_limit=10",
            approvalsurl: "/api/now/table/sysapproval_approver?sysparm_query=approver.first_name%3D{username_first_name}%5Eapprover.last_nameSTARTSWITH{username_last_name}%5Estate%3Drequested&sysparm_display_value=true&sysparm_fields=sys_id%2Cstate%2Capprover%2Csysapproval%2Cdocument_id.short_description%2Cdocument_id.description%2Cdocument_id.opened_by%2Csys_id&sysparm_limit=10",
    ...
    componentDidMount() {
        ...
        if (botservices !== null) {
            ...
            var snowbot_enabled_bot_services = JSON.parse(localStorage.getItem("snowbot_enabled_bot_services"));

            if (snowbot_enabled_bot_services !== null) {

                snowbot_enabled_bot_services.forEach(service => {
                    console.log(service);
    ...
    onSubmitButtonClick() {
        ...
        if (this.state.getincidentsval == true) {
            const getincidents_obj =
            {
                ...
                "service_end_point_url": "/api/now/table/incident?sysparm_query=assigned_to.first_name%3D{username_first_name}%5Eassigned_to.last_nameSTARTSWITH{username_last_name}%5EstateNOT%20IN3%2C6%2C7%2C8&sysparm_fields=number%2Cshort_description%2Cpriority%2Cbusiness_duration%2Csys_id&sysparm_limit=10"
            }
        ...
        if (this.state.getchangesval == true) {
            ...
            const getchanges_obj =
            {
                ...
                "service_end_point_url": "/api/now/table/change_request?sysparm_query=assigned_to.first_name%3D{username_first_name}%5Eassigned_to.last_nameSTARTSWITH{username_last_name}%5EstateNOT%20IN3%2C6%2C7%2C8&sysparm_fields=number%2Cshort_description%2Cpriority%2Cbusiness_duration%2Csys_id&sysparm_limit=10"
            }
        ...
        if (this.state.approvalsval == true) {
            const approvals_obj =
            {
                ...
                "service_end_point_url": "/api/now/table/sysapproval_approver?sysparm_query=approver.first_name%3D{username_first_name}%5Eapprover.last_nameSTARTSWITH{username_last_name}%5Estate%3Drequested&sysparm_display_value=true&sysparm_fields=sys_id%2Cstate%2Capprover%2Csysapproval%2Cdocument_id.short_description%2Cdocument_id.description%2Cdocument_id.opened_by%2Csys_id&sysparm_limit=10"
            }
            this.state.enabled_bot_services.push(approvals_obj);
        }
        const { enabled_bot_services } = this.state;
        localStorage.setItem('snowbot_enabled_bot_services', JSON.stringify(enabled_bot_services));
	this.props.history.push("/bots/snowchannels");

    }
    onPreviousButtonClick() {
        this.props.history.push("/bots/config/snowbot");
    }
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="custom-control custom-switch newpillclass">
                                                    <input type="checkbox" onChange={this.handleInputChange} checked={this.state.getchangesval} value={this.state.getchangesval} className="custom-control-input" id="switch1" name="getchangesval" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="custom-control custom-switch newpillclass">
                                                    <input type="checkbox" onChange={this.handleInputChange} checked={this.state.approvalsval} value={this.state.approvalsval} className="custom-control-input" id="switch3" name="approvalsval" />
...
export default SNOWBotServices;
